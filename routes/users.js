...
router.post('/register',(req,res) => {
    ...
    const {name,email, password, password2, address, referralCode} = req.body

    let errors = []

    console.log('Name: ' + name + ' email: ' + email + ' pass: ' + password + ' address: ' + address + ' referralCode: ' + referralCode)
